...
model LevelControl_2 "Level control with a PI controller"
  ...
  parameter Real Tact=5   "|Process| Actuator dynamics";
  ...
  parameter Real CSmin=0.2 "|Controller| minimum value of the CS";
